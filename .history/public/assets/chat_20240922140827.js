...
function sendMessage(message) {
    ...
    userMessageDiv.innerHTML = `
        <div class="message-wrapper">
            <img src="{{ asset('assets/images/photo-1.jpg') }}" alt="User Photo" class="message-avatar user-avatar">
            <div class="message-content">${message}</div>
        </div>`;
        <div class="message-wrapper">
        <img src="${userAvatarPath}" alt="User Photo" class="message-avatar user-avatar">
        <div class="message-content">${message}</div>
    </div>`;
    ...
    fetch(`/chat?message=${encodeURIComponent(message)}`)
        ...
        .then(data => {
            ...
            botMessageDiv.innerHTML = `
                <div class="message-wrapper">
                    <img src="{{ asset('assets/images/llama.jpg') }}" alt="Llama3 Logo" class="message-avatar bot-avatar">
